...
const workVisuals: Record<string, WorkVisuals> = {
  ...
  "sivka-burka": { hero: { src: "/literature-guide/context/sivka-burka.webp", alt: "Иванушка и Сивка-бурка на рассвете" }, context: { src: "/literature-guide/context/sivka-context.webp", alt: "Ярмарка и высокая башня в сказочном городе" }, read: { src: "/literature-guide/context/sivka-read.webp", alt: "Сивка-бурка прыгает к окну высокой башни" } },
  "ivan-tsarevich-and-grey-wolf": { hero: { src: "/literature-guide/context/ivan-tsarevich-wolf.webp", alt: "Иван-царевич и Серый Волк на лесной дороге" }, context: { src: "/literature-guide/context/ivan-context.webp", alt: "Жар-птица в золотой клетке в ночном лесу" }, read: { src: "/literature-guide/context/ivan-read.webp", alt: "Иван-царевич и Серый Волк на дороге к рассвету" } },
  "krylov-wolf-and-lamb": { hero: { src: "/literature-guide/context/krylov-wolf-lamb.webp", alt: "Волк и ягнёнок у ручья в утреннем пейзаже" }, context: { src: "/literature-guide/context/krylov-context.webp", alt: "Ручей течёт от высокого лесного берега к открытому лугу" }, read: { src: "/literature-guide/context/krylov-read.webp", alt: "Ягнёнок уходит от вечернего берега под тенью волка" } },
  "pushkin-dead-princess": { hero: { src: "/literature-guide/context/pushkin-dead-princess.webp", alt: "Заснеженная лесная поляна и дом семи богатырей" } },
  "lermontov-borodino": { hero: { src: "/literature-guide/context/lermontov-borodino.webp", alt: "Бородинское поле, редут и пушка на рассвете" } },
  "gogol-night-before-christmas": { hero: { src: "/literature-guide/context/gogol-christmas-night.webp", alt: "Зимняя деревня в рождественскую ночь" } },
  "turgenev-mumu": { hero: { src: "/literature-guide/context/turgenev-mumu.webp", alt: "Московский двор у господского дома в 1840-е годы" } },
  "tolstoy-caucasian-prisoner": { hero: { src: "/literature-guide/context/tolstoy-caucasian-prisoner.webp", alt: "Горное селение и дорога в кавказской долине" } },
  "chekhov-kashtanka": { hero: { src: "/literature-guide/context/chekhov-kashtanka.webp", alt: "Городская улица с фонарями и Каштанка в конце XIX века" } }
};

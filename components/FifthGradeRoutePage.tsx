...
const workVisuals: Record<string, WorkVisuals> = {
  ...
  "sivka-burka": { hero: { src: "/literature-guide/context/sivka-burka.webp", alt: "Иванушка и Сивка-бурка на рассвете" }, context: { src: "/literature-guide/context/sivka-context.webp", alt: "Ярмарка и высокая башня в сказочном городе" } },
  "ivan-tsarevich-and-grey-wolf": { hero: { src: "/literature-guide/context/ivan-tsarevich-wolf.webp", alt: "Иван-царевич и Серый Волк на лесной дороге" } },

  ...
  return (
    <main className="after-ball-page">
      ...
      <section className="after-ball-author" id="tolstoy">
        <TolstoyPortrait compact showAge={false} />
        <div>
          <p className="eyebrow">КТО НАПИСАЛ ЭТОТ ТЕКСТ</p>
          <h2>Лев Толстой<br />в 15 лет.</h2>
          <p>Он ещё не великий писатель и не Толстой из учебника. Он живёт в Казани с тёткой, занимается с частными учителями, готовится к поступлению и пытается понять, каким человеком хочет стать.</p>
          <p>До «После бала» ещё шестьдесят лет. Пока он не знает, что напишет великие книги. Но уже нащупывает свой вопрос: как не привыкнуть к несправедливости и отвечать за свои поступки.</p>
          <div className="after-ball-author-facts"><span>1843–1844 · Казань</span><span>Готовится к поступлению</span><span>До славы — ещё далеко</span></div>
        </div>
      </section>
